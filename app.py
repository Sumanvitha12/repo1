from flask import *
import ibm_db
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=21fecfd8-47b7-4937-840d-d791d0218660.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31864;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=swd72994;PWD=6409cuNzdctJCRiM",'','')
print(conn)
app=Flask(__name__)
@app.route('/')
def home():
